...
const router = createRouter({
    ...
    routes: [{
        ...
        },
        {
            ...
            name: 'Association',
            component: () =>
                import ('../pages/Association.page.vue'),
        },
        {
            path: '/observatoire/comite-scientifique',
            name: 'ComiteScientifique',
            component: () =>
                import ('../pages/ComiteScientifique.page.vue'),
        },
        {
            path: '/observatoire/publications',
            name: 'Publications',
            component: () =>
                import ('../pages/Publications.page.vue'),
        },
        {
            path: '/observatoire/publications/:id',
            name: 'Publication',
            component: () =>
                import ('../pages/Publication.page.vue'),
        ...
        },
        {
            ...
            name: 'Presses',
            component: () =>
                import ('../pages/Presses.page.vue'),
        },
        {
            path: '/presses/:id',
            name: 'Presse',
            component: () =>
                import ('../pages/Presse.page.vue'),
        },
        {
            path: '/contact',
            name: 'Contact',
